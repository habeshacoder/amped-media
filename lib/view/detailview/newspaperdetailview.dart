...
class NewsPaperDetailView extends StatefulWidget {
  NewsPaperDetailView({required this.book});
  final MaterialModel book;
  @override
  State<NewsPaperDetailView> createState() => _NewsPaperDetailViewState();
}

class _NewsPaperDetailViewState extends State<NewsPaperDetailView> {
  double _rating = 0;
