...
class ReviewChannel extends StatefulWidget {
  ReviewChannel({required this.book});
  final ChannelModel book;

  @override
  State<ReviewChannel> createState() => ReviewChannelState();
}

class ReviewChannelState extends State<ReviewChannel> {
...
//save review
  void rate() async {
    ...
    Navigator.of(context).pop(MaterialPageRoute(
      builder: (context) => BookChannelDetailView(book: widget.book),
    ));
  }
}
