...
import 'package:ampedmedia_flutter/view/detailview/newspaperdetailview.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:provider/provider.dart';

class PopularNewspaper extends StatefulWidget {
  const PopularNewspaper({super.key});

  @override
  State<PopularNewspaper> createState() => _PopularNewspaperState();
}

class _PopularNewspaperState extends State<PopularNewspaper> {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('these are popular and trending Newspapers')
              ],
            ),
          ),
          Container(
                        ...
                        if (snapshot.hasData) {
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) => InkWell(
                              onTap: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => NewsPaperDetailView(
