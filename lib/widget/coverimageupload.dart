...
class ProfileCoverImgaeUpload extends StatefulWidget {
  ProfileCoverImgaeUpload({required this.uploadProfilecover});
  final Function(dynamic) uploadProfilecover;

  @override
  State<ProfileCoverImgaeUpload> createState() =>
      _ProfileCoverImgaeUploadState();
}

class _ProfileCoverImgaeUploadState extends State<ProfileCoverImgaeUpload> {
    ...
    try {
      ...
      if (pickedFile != null) {
        ...
        if (width != 1920 || height != 1080) {
          print('${width} ${height}');
          setState(() {
            dimensionCheck = 'Cover image dimensions must be 1920 x 1080';
          });
          return;
        }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('. Cover image dimension must be 1920 X 1080'),
